...
// 현재 지도를 보고, 플레이어의 상황에 맞게 출력해주는 함수.
// 지도의 값을 읽어 'ㅁ'을 한자로 바꾼 모양 중 적절한 모양을 프린트한다.
...
// row 선택인지 column 선택인지에 따라 숫자를 받는 함수.
// row의 경우 1, column인 경우 0이 입력된다.
