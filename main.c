...
// 먼저 kill_mine 모드입니다.
//
// 이 모드는 원작 지뢰찾기에 오른쪽 마우스 버튼과 어느 정도 대응되며,
// 지뢰라고 생각되는 좌표를 선택할 수 있습니다.
// 만약 지뢰라면, 지뢰임이 드러나고, 지뢰가 아니라면, 게임에서 패배합니다.
//
// 그 다음은 select 모드입니다.
//
// 이 모드는 원작 지뢰찾기의 왼쪽 마우스 버튼과 어느 정도 대응되며,
// 좌표를 하나 선택할 수 있습니다.
// 만약 이 좌표가 지뢰라면 게임에서 패배합니다.
// 지뢰가 아니라면, 그 칸의 숫자를 드러내거나,
// 숫자가 없는 빈 칸이라면, 연쇄적으로 칸들을 탐색하여 숫자들을 드러냅니다.
//
